...
namespace seneca
{
	...
	DepositInfo& DepositInfo::operator=(const DepositInfo &otherDepositInfo)
	{
		strcpy(m_transit, otherDepositInfo.m_transit);
		strcpy(m_institution, otherDepositInfo.m_institution);
		strcpy(m_account, otherDepositInfo.m_account);
