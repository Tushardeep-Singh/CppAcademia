...
namespace seneca
{
  ...
  void Event::display()
  {
    ...
    std::cout << ". ";
    if (m_eventStartTime == 0 || m_eventDescription == nullptr)
    {
      std::cout << "| No Event |\n";
      return;
    }
  ...
  void Event::set(const char arr[])
  {
    ...
    if (m_eventDescription != nullptr)
    {
      delete[] m_eventDescription;
      m_eventDescription = nullptr;
    }
    m_eventDescription = new char[EVENT_DESCRIPTION_LENGTH + 1];
