...
int main()
{
    ...
    if (act)
        ...
        cout << "Unable to change strings (incorrect)" << endl;
    act = gu2.changeString(GuitarStr{"Nylon", 0.77}, 9);
    if (!act)
        cout << "Unable to change string (correct)" << endl;
    printDivider();
